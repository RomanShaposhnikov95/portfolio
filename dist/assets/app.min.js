"use strict";$(window).scroll((function(){$(this).scrollTop()>500?$(".pageup").fadeIn():$(".pageup").fadeOut()})),$("a[href^='#']").click((function(){var e=$(this).attr("href");return $("html, body").animate({scrollTop:$(e).offset().top+"px"}),!1}));var hamburger=document.querySelector(".hamburger"),menu=document.querySelector(".menu-adaptive"),close=document.querySelector(".menu-adaptive_close");hamburger.addEventListener("click",(function(){menu.classList.add("active")})),close.addEventListener("click",(function(){menu.classList.remove("active")}));var modal=document.querySelector(".overlay"),openBtn=document.querySelector(".open"),closeBtn=document.querySelector(".modal_close");function valideForms(e){$(e).validate({rules:{name:{required:!0,minlength:2},phone:"required",email:{required:!0,email:!0}},messages:{name:{required:"Пожалуйста, введите имя",minlength:jQuery.validator.format("Введите 1 символов!")},phone:"Пожалуйста, введите телефон!",email:{required:"Пожалуйста, введите почту!",email:"Неправильно, Пожалуйста, введите почту!"}}})}openBtn.addEventListener("click",(function(){modal.style.display="flex",document.body.style.overflow="hidden"})),closeBtn.addEventListener("click",(function(){modal.style.display="none",document.body.style.overflow="auto"})),valideForms("#order form"),$("input[name=phone]").mask("+ 371 99999999");
